...
const defaultFactors: Factor[] = [
  { label: 'Sea Surface Temperature (SST)', weight: '+0.34', detail: '28.4°C optimal thermal gradient aligned with seasonal pelagic feeding', status: 'positive' },
  { label: 'Chlorophyll-a Concentration', weight: '+0.28', detail: 'High bloom verified by INSAT-3DR ocean color monitor', status: 'positive' },
  { label: 'Wave & Swell Conditions', weight: '+0.18', detail: '1.2m significant wave height below dangerous threshold (<2.5m)', status: 'positive' },
  { label: 'Historical AIS Fishery Density', weight: '+0.12', detail: 'Consistent high catch rates in Sector K-04 over past 3 years', status: 'positive' },
  { label: 'Weather & Cyclone Forecast', weight: '+0.08', detail: 'No convective storm systems within 250km for next 36h', status: 'positive' },
];
...
export default function ProvenanceModal({
  ...
  recommendation = 'PFZ Zone K-04 (Off Kochi Coast)',
