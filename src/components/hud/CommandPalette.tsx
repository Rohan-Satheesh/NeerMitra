  ...
  const commandList: CommandItem[] = [
    {
      id: 'cmd-ocean',
      category: 'Navigation',
      title: 'Open Live Ocean Map',
      subtitle: 'View real-time SST, currents, and wave dynamics',
      icon: Compass,
      action: () => { navigate('/ocean'); onClose(); },
      shortcut: 'G O'
    },
    {
      id: 'cmd-dashboard',
    ...
    },
    {
      ...
      title: 'Inspect Agent Network',
      subtitle: '10 specialist agents execution graph & telemetry',
      icon: Cpu,
    ...
    },
    {
      id: 'cmd-alerts',
      category: 'Safety',
      title: 'View Marine Alerts',
      subtitle: 'Cyclone warnings, high wave advisories, and geofence events',
      icon: AlertTriangle,
    ...
    },
    {
      id: 'cmd-analytics',
      category: 'Analytics',
      title: 'Fleet & Ocean Analytics',
      subtitle: 'Historical performance, Pareto curves & emissions MRV',
      icon: LineChart,
    ...
    },
    {
      id: 'cmd-architecture',
      category: 'System',
      title: 'System Architecture (5-Layer)',
      subtitle: 'Inspect the NeerMitra Marine OS pipeline',
      icon: Layers,
    ...
    },
    {
      id: 'cmd-vessel-sagar',
      category: 'Vessels',
      title: 'Track Sagar Kanya (V001)',
      subtitle: 'Container • 15.3°N, 70.2°E • 18.5 kn • Optimized',
      icon: Ship,
      action: () => { navigate('/dashboard'); onClose(); }
    },
    {
      id: 'cmd-vessel-voyager',
      category: 'Vessels',
      title: 'Track Coastal Voyager (V002)',
      subtitle: 'Tanker • 14.8°N, 73.5°E • 12.0 kn • Warning',
      icon: Ship,
      action: () => { navigate('/dashboard'); onClose(); }
    },
    {
      ...
      title: 'Find PFZ Zone K-04 (Off Kochi)',
      subtitle: 'Confidence: 87% • SST: 28.4°C • Chlorophyll: High',
      icon: MapPin,
      action: () => { navigate('/ocean'); onClose(); }
    }
  ];
